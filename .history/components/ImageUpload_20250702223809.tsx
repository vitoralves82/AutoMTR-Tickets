...
// Corrige o caminho do worker para a versão legacy (necessário pro Vite/Vercel funcionar bem)
    ...
    if (file.type === 'application/pdf') {
      ...
      reader.onload = async (event) => {
        try {
          ...
          if (!arrayBuffer) throw new Error('Não foi possível ler o arquivo PDF.');
          ...
          alert(`Erro ao converter PDF para imagem: ${err instanceof Error ? err.message : String(err)}`);
          if (fileInputRef.current) fileInputRef.current.value = "";
        } finally {

...
Analise a imagem fornecida de um formulário MMR. Seja estritamente fiel ao texto na imagem. Não deduza, infira ou corrija informações que não estejam claramente visíveis.
Extraia os seguintes campos do cabeçalho. Preste muita atenção aos rótulos exatos.
Os campos a serem extraídos são:
- "MMR N°": (O número do MMR, exemplo: "027/2025")
- "DATA": (A data associada ao GERADOR, geralmente localizada mais à esquerda no formulário. Ignore outras datas. Exemplo: "27-fev-25")
...
Para CADA item da tabela, extraia os seguintes campos. Seja estritamente fiel ao texto na imagem para cada campo. Não deduza, infira ou corrija informações que não estejam claramente visíveis. Preste muita atenção aos cabeçalhos das colunas.
